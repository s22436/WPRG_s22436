...
if($shouldSave != null && $name != null && $surname != null && $numOfPpl != null && $credit != null && $email != null && $date != null && $time != null){
    ...
    // Saving to a file
    $myfile = fopen("form.csv", "w") or die("Unable to open file!");
    $formToSave = "";
    ...
    if($line){
        ...
        $i = 0;
//        ?name=Marcin&surname=Hesse&numOfPpl=1&credit=1231231231231231&email=sfdsdf%40fda.as&date=1999-03-12&time=11:11&baby=on&smoke=off&ac=off&breakfast=on
//        ?&name=dfadfs&surname=1&numOfPpl=3234234234233423&credit=sfddf@dfs.sdf&email=2023-04-04&date=18:11&time=on&baby=&smoke=&ac=onname&breakfast =surname
        $result = "?";
